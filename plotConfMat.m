...
% plotting the colors
imagesc(confpercent);
title(sprintf('Balanced Accuracy: %.2f%%', 100*(confmat(1,1)/(confmat(1,1)+confmat(2,1)) + confmat(2,2)/(confmat(2,2) + confmat(1,2)))/2), 'FontSize', 13)
   %100*( 1*confmat(1,1)/(confmat(1,1)+confmat(2,1)) + 2*confmat(2,2)/(confmat(2,2) + confmat(1,2)))/3 ));
ylabel('Output Class', 'FontSize',15); xlabel('Target Class','FontSize',15);
